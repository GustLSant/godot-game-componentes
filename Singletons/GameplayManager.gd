...
func _ready() -> void:
	var attLoadout_01: T_StartWeaponAttachmentsLoadout = T_StartWeaponAttachmentsLoadout.new()
	...
	var attLoadout_02: T_StartWeaponAttachmentsLoadout = T_StartWeaponAttachmentsLoadout.new()
	attLoadout_02.paths[T_AttachmentType.ENUM.DEVICE_R] = "res://Components/PlayerWeapons/Attachments/RedLaserDevice.tscn"
